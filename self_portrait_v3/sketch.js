...
//faceBlue = MouseX;
  faceRed = map (mouseY, 0, height, 200)
  // the value that changes
  // min and max of the range of that value
   ...
   circle(x+50,y-50,eyeSize) //right
    ...
    var mouthHeight = map (mouseY, 0, height, mouthSize / 18, mouthSize);

	rect(x-100, y+70, mouthSize, mouthHeight, mouthSize / 10);
